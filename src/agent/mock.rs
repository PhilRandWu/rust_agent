...
impl MockNode {
    pub fn key(self) -> &'static str {
        match self {
            ...
            Self::Structure => "structureNode",
            Self::Dependency => "dependencyNode",
            Self::Type => "typeNode",
            Self::Utils => "utilsNode",
            Self::MockData => "mockDataNode",
            Self::Service => "serviceNode",
            Self::Hooks => "hooksNode",
            Self::ComponentGen => "componentGenNode",
            Self::PageGen => "pageGenNode",
            Self::Layout => "layoutNode",
            Self::StyleGen => "styleGenNode",
            Self::AppGen => "appGenNode",
            Self::Assemble => "assembleNode",
            Self::PostProcess => "postProcessNode",
            Self::Plan => "planNode",
    ...
    pub fn file_name(self) -> &'static str {
        match self {
            ...
            Self::Structure => "structure_result.json",
            Self::Dependency => "dependency_result.json",
            Self::Type => "type_result.json",
            Self::Utils => "utils_result.json",
            Self::MockData => "mock_data_result.json",
            Self::Service => "service_result.json",
            Self::Hooks => "hooks_result.json",
            Self::ComponentGen => "component_gen_result.json",
            Self::PageGen => "page_gen_result.json",
            Self::Layout => "layout_result.json",
            Self::StyleGen => "style_gen_result.json",
            Self::AppGen => "app_gen_result.json",
            Self::Assemble => "assemble_result.json",
            Self::PostProcess => "post_process_result.json",
